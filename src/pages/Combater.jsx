        ...
        <div className="flex flex-col gap-20 justify-center items-center align-center" style={{ height: "80vh" }}>
            ...
            <div className="flex gap-20 justify-center align-center items-center text-white">
                <div className="flex flex-col items-center gap-10">
                    <img src="./src/assets/dieta.png" alt="Icone Garfo" style={{ height: "10vh", width: "10vh" }} />
                ...
                <div className="flex flex-col items-center gap-10">
                    <img src="./src/assets/lanche-icon.png" alt="Icone Garfo" style={{ height: "10vh", width: "10vh" }} />
                ...
                <div className="flex flex-col items-center gap-10">
                    <img src="./src/assets/peoples-icon.png" alt="Icone Garfo" style={{ height: "10vh", width: "10vh" }} />
